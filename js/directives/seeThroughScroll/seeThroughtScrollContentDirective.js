...
const directiveName = "seeThroughtScrollElement";

export const seeThroughtScrollElementDirective = () => ({
	restrict: "A",
	scope: false,
...
DopApp.directive(directiveName, seeThroughtScrollElementDirective);